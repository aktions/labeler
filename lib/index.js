...
const labeler_1 = __webpack_require__(759);
const configuration_1 = __webpack_require__(961);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const config = new configuration_1.Configuration(github);
            config.load(configPath);
            const labeler = new labeler_1.Labeler(github);
            const files = yield labeler.diff();
            const labels = labeler.match(config, files);
            if (labels.length > 0) {
                yield labeler.addLabels(labels);
            }
        }
        catch (error) {
            core.error(error);
...
var deepmerge = _interopDefault(__webpack_require__(867));
var isPlainObject = _interopDefault(__webpack_require__(696));
var urlTemplate = _interopDefault(__webpack_require__(714));
...
class GlobMatcher {
    constructor(pattern) {
        this.m = new minimatch_1.Minimatch(pattern);
    }
    match(str) {
...
class Labeler {
    ...
    diff() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.github.pulls.listFiles({
    ...
    addLabels(labels) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.github.issues.addLabels({
                owner: github_1.context.repo.owner,
                repo: github_1.context.repo.repo,
...
const matcher_1 = __webpack_require__(542);
class Configuration {
    constructor(github) {
        this.size = 0;
        this.github = github;
    ...
    load(path) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.github.repos.getContents({
                owner: github_1.context.repo.owner,
                repo: github_1.context.repo.repo,
                path: path,
    ...
    parse(raw) {
        ...
        for (let label in labelMatchers) {
            ...
            this.config.set(label, matchers.map((matcher) => {
                if (util_1.isRegExp(matcher)) {
                    return new matcher_1.RegExpMatcher(matcher);
                }
                else if (util_1.isString(matcher)) {
                    return new matcher_1.GlobMatcher(matcher);
                }
